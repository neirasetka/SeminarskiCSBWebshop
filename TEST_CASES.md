...
**Runnable API flow script:** [`scripts/test-api-flows.ps1`](scripts/test-api-flows.ps1)  
**API cases (current copy):** [`docs/ApiTestCases.md`](docs/ApiTestCases.md)

> Dart widget tests listed below came from PR #127 (`cursor/webshop-test-caseovi-2772`, closed without merge). They were never merged to `main`.
...
| Backend API | `docs/ApiTestCases.md` | 60+ |
